...
def setup_route_and_program(canister_id: str, page: str, params: str = None, use_random_key: bool = False, ic_mode: bool = False) -> bool:
    ...
    try:
        ...
        if use_random_key:
            ...
            cmd = f'python3 scripts/hashed_cmacs.py -k {new_key_str} -u {card_uid} -c 15000 -o cmacs.json'
        else:
            # Generate CMACs with default key
            cmd = f'python3 scripts/hashed_cmacs.py -k 00000000000000000000000000000000 -u {card_uid} -c 15000 -o cmacs.json'
